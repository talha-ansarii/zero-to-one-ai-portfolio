...
export default function BlueBackgroundWrapper({ children }: BlueBackgroundWrapperProps) {
    ...
    return (
      <div className={`relative z-[70] h-[calc(100dvh-20px)] mt-[10px] w-[calc(100vw-20px)] ml-[10px] md:h-[calc(100vh-50px)] md:w-[calc(100vw-50px)] md:mt-[25px] md:ml-[25px] rounded-[20px] md:rounded-[25px] bg-gray-100 overflow-visible ${isShort ? 'short-screen' : ''}`}>
  ...
  <div className="absolute right-4 sm:right-6 lg:right-6 h-[30px] z-[50] top-4 sm:top-6 md:top-8 flex gap-2">
          <HamburgerMenu />
        </div>
